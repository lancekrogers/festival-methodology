...
var templateAliases = map[string]string{
	...
	"task-simple":      "TASK_TEMPLATE_SIMPLE.md",
	"task-minimal":     "TASK_TEMPLATE_MINIMAL.md",
	"sequence":         "SEQUENCE_GOAL_TEMPLATE.md",
	"sequence-minimal": "SEQUENCE_GOAL_MINIMAL.md",
	"phase":            "PHASE_GOAL_TEMPLATE.md",
	"phase-impl":       "PHASE_GOAL_IMPLEMENTATION_TEMPLATE.md",
	"phase-planning":   "PHASE_GOAL_PLANNING_TEMPLATE.md",
	"phase-research":   "PHASE_GOAL_RESEARCH_TEMPLATE.md",
	"phase-review":     "PHASE_GOAL_REVIEW_TEMPLATE.md",
	"festival":         "FESTIVAL_GOAL_TEMPLATE.md",
	"festival-goal":    "FESTIVAL_GOAL_TEMPLATE.md",
	"festival-overview": "FESTIVAL_OVERVIEW_TEMPLATE.md",
	"festival-todo":    "FESTIVAL_TODO_TEMPLATE.md",
	"festival-rules":   "FESTIVAL_RULES_TEMPLATE.md",
	"gate-testing":     "QUALITY_GATE_TESTING.md",
	"gate-review":      "QUALITY_GATE_REVIEW.md",
	"gate-iterate":     "QUALITY_GATE_ITERATE.md",
}
