...
# Task {{.task_id}}
`,
		"gates/QUALITY_GATE_TESTING.md": "# Testing Gate\n",
		"gates/QUALITY_GATE_REVIEW.md":  "# Review Gate\n",
		"gates/QUALITY_GATE_ITERATE.md": "# Iterate Gate\n",
		"gates/QUALITY_GATE_COMMIT.md":  "# Commit Gate\n",
	}
